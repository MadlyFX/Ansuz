// ogui_bridge.h — C interface to the Odin-compiled OGUI library.
// Include this in your Arduino sketch or C/C++ application.

#ifndef OGUI_BRIDGE_H
#define OGUI_BRIDGE_H
#endif 
...
// Initialize the OGUI framework and software renderer.
...
static inline void ogui_framebuffer_to_ssd1306(const uint32_t* rgba, uint8_t* mono) {
